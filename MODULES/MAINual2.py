...
#fonction wrtmotor() écrire le fichier moteur.txt pour éviter de tourner une deuxième fois la boucle
def wrtmotor():
    fichier = open("/var/www/RaspberryPI/moteur/moteurs.txt", "w")
    fichier.write("0")
    fichier.close()
